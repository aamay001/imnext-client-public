...
export const INFO = {
  SETTINGS : {
    ...
    PROVIDER_NAME_MESSAGE: 'The provider name is what your clients will use to schedule an appointment with you. Your provider name can be your company name, your personal handle, or something unique that your clients can use to identify you. You should tell your clients to use your provider name when scheduling an appointment.',
    FIXED_WORK_DAYS_TITLE: 'Fixed Work Days',
    FIXED_WORD_DAYS_MESSAGE: 'In FIXED schedule mode, you can select which days you work on and use the same schedule for each day. For example, if you work from Monday - Friday, set Saturday and Sunday to off and Monday - Friday to on.'
  }
}
