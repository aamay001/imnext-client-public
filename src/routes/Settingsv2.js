...
export class Settings extends Component {
  ...
  render() {
    ...
    const suffix = providerName ? <Icon type="close-circle" onClick={this.clearProviderName} /> : null;
    let tabs;
      ...
      tabs = this.props.user.workTimes.map((workDay, index) => {
        ...
        return (
          <TabPane tab={<span><Icon type={
            this.props.user.workDays[index] ? 'check' : 'minus'
          } />{thisDay}</span>} key={thisDay} style={{
            marginTop: '-10px'
          }}>
            <h2>{thisDay}</h2>
            ...
            <div className="settings-toggle-switch">
              ...
              <h4 style={{
                ...
                marginLeft: '10px',
                marginTop: '0'
              }}>{this.props.user.workDays[index] ? 'Work Day': 'Day Off'}</h4>
              <Switch
          ...
          <Form onSubmit={this.onSubmit}>
            <h2>Provider Name
              <Button shape="circle" icon="info"
                onClick={() =>
                  this.info(INFO.SETTINGS.PROVIDER_NAME_TITLE,
            ...
            <h2>Schedule Type
              <Button shape="circle" icon="info"
              onClick={() =>
                this.info(INFO.SETTINGS.SCHEDULE_TYPE_TITLE,
            ...
            <div className="settings-toggle-switch">
              ...
              <h4 style={{
                ...
                marginLeft: '10px',
                marginTop: '0'
              }}>{this.props.user.scheduleType}</h4>
              <Switch
                name="scheduleType"
                id="scheduleType"
                size="large"
            ...
            { this.props.user.scheduleType === 'CUSTOM' ?
              ...
              <div className="fixed-settings">
                <h2>Work Days
                  <Button shape="circle" icon="info"
                    onClick={() =>
                      this.info(INFO.SETTINGS.FIXED_WORK_DAYS_TITLE,
                ...
                <label>
                  What days of the week do you work on?
                </label>
                {days.map((day, index) => {
                  return (
                    <div className="settings-toggle-switch" key={`settingsTSKey${day}`}>
                      <Icon type="calendar" />
                      <h4 style={{
                        display: 'inline-block',
                        marginLeft: '10px',
