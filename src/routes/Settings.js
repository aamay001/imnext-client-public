        ...
        <Logo />
          <div className="form-container">
            <form onSubmit={this.onSubmit}>
              <h2>Provider Name</h2>
              <label htmlFor="providerName">This is the name people use to find you.</label>
              <input type="text"
              id ="providerName"
              name="providerName"
              required
              ...
              <label htmlFor="appointmentTime">How long does each appointment take? (in minutes)</label>
              <input type="number"
                min="10"
                max="120"
              ...
              <div className="field-group">
                ...
                <label htmlFor="workDayStartTime">Time of first appointment.</label>
                <input type="time"
                  id ="workDayStartTime"
              ...
              <div className="field-group">
                ...
                <label htmlFor="workBreakStartTime">Time you take a lunch break.</label>
                <input type="time"
              ...
              <div className="field-group">
                ...
                <label htmlFor="workBreakLengthMinutes">How long is your lunch break? (in minutes)</label>
                <input type="number"
                  min="10"
                  max="120"
                  required
              ...
              <p style={{
                textAlign: 'center',
                color: 'dodgerblue'
              }}>{this.props.updateMessage}</p>
              <button type="submit"
                disabled={!this.props.settingsChanged || this.props.updatingSettings}>
              Save
            </button>
            </form>
        </div>
