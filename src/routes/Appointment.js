  ...
  getAvailbleTimeSlots = (e) => {
    if ( e.target.checkValidity()  ) {
      ...
      this.props.dispatch(
        getAvailableTimeSlots(
          dateVal,
          this.props.appointmentData.providerId
        )
      );
    }
  }
    ...
    return (
      <section className="scheduling-page">
        ...
        <form id="appointment-form-1"
          ...
          <Recaptcha ref={recap => this.recaptcha = recap}
        ...
        <form id="appointment-form-2"
          ...
          <ProviderSearch inputId="provider-search"
          ...
          <input type="date"
            ...
            required
            autoComplete="off"
            disabled={this.props.requestingHumanValidation ||
