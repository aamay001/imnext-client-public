                    ...
                    this.props.location.pathname !== ROUTES.DASHBOARD ?
                        <li style={{height: height }}>
                            <Link to={ROUTES.DASHBOARD}
                                style={{display: show}}>Dashboard</Link>
                        </li> : '' }
                    {
                    !this.props.isUserLoggedIn &&
                    this.props.location.pathname !== ROUTES.LOGIN ?
                        <li style={{height: height }}>
                            <Link to={ROUTES.LOGIN}
                                style={{display: show}}>Log In</Link>
                        </li> : '' }
                    {
                    this.props.isUserLoggedIn &&
                    ...
                    this.props.location.pathname !== ROUTES.SCHEDULE ?
                        <li style={{height: height }}>
                            <Link to={ROUTES.SCHEDULE}
                                style={{display: show}}>Schedule</Link>
                        </li> : '' }
                    {
                    this.props.isUserLoggedIn ?
                        <li style={{height: height }}>
                            <Link to={ROUTES.LOGOUT}
                                style={{display: show}}>Log Out</Link>
                        </li> : '' }
                </ul>
            </nav>
        );
